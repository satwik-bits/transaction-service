...
public class NotificationServiceProducerConfig {
    ...
    private Map<String, Object> notificationProducerConfigs() {
        ...
        props.put(ProducerConfig.ACKS_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.BATCH_SIZE_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.LINGER_MS_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.MAX_REQUEST_SIZE_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.BUFFER_MEMORY_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.MAX_BLOCK_MS_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.COMPRESSION_TYPE_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, kafkaBootstrapServers);
        props.put(ProducerConfig.METADATA_MAX_AGE_CONFIG, kafkaBootstrapServers);
        props.put(ProducerConfig.CONNECTIONS_MAX_IDLE_MS_CONFIG, kafkaBootstrapServers);
